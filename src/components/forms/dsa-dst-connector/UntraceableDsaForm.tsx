...
import {
  VerificationTask, UntraceableDsaReportData, CallRemarkUntraceable, LocalityTypeResiCumOffice, DominatedArea, FinalStatus, TaskStatus
} from '../../../types';
...
const UntraceableDsaForm: React.FC<UntraceableDsaFormProps> = ({ taskData }) => {
  const navigation = useNavigation<any>();
    const { updateUntraceableDsaReport, toggleSaveTask , fetchTasks , updateTaskStatus} = useTasks();
  ...
  if (!report) {
    return <Text>No Untraceable DSA/DST report data available.</Text>;
  }
  ...
  return (
    <AutoSaveFormWrapper
      ...
      <View>
      <Text>Untraceable DSA Report</Text>
