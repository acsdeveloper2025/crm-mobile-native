...
const NspDsaForm: React.FC<NspDsaFormProps> = ({ taskData }) => {
  const navigation = useNavigation<any>();
    const { updateNspDsaReport, toggleSaveTask , fetchTasks , updateTaskStatus} = useTasks();
  ...
  if (!report) {
    return <Text>No NSP DSA/DST report data available.</Text>;
  }
  ...
  return (
    <AutoSaveFormWrapper
      ...
      {report.officeStatus === OfficeStatusOffice.Opened && (
        <View>
          <Text>Additional Details (Office Open)</Text>
          <View>
