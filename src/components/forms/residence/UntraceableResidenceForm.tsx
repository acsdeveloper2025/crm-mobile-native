...
import {
  VerificationTask, UntraceableResidenceReportData, CallRemarkUntraceable, LocalityType, DominatedArea, FinalStatus, TaskStatus
} from '../../../types';
...
const UntraceableResidenceForm: React.FC<UntraceableResidenceFormProps> = ({ taskData }) => {
  ...
  const { updateUntraceableResidenceReport, toggleSaveTask, fetchTasks , updateTaskStatus} = useTasks();
  ...
  const handleChange = (name: string, value: any) => {
    ...
    updateUntraceableResidenceReport(taskData.id, { [name]: processedValue });
  };
  ...
  if (!report) {
    return (
      <View style={styles.container}>
        <Text style={[{ color: theme.colors.danger }, styles.noDataText]}>No Untraceable Residence report data available.</Text>
      </View>
    );
  }
  ...
  return (
    <AutoSaveFormWrapper
      ...
      <ScrollView style={styles.container}>
        <Text style={[styles.title, { color: theme.colors.text }]}>Untraceable Residence Report</Text>
