...
const EntryRestrictedResidenceForm: React.FC<EntryRestrictedResidenceFormProps> = ({ taskData }) => {
  ...
  const { updateEntryRestrictedResidenceReport, toggleSaveTask, fetchTasks , updateTaskStatus} = useTasks();
  ...
  const handleChange = (name: string, value: any) => {
    ...
    updateEntryRestrictedResidenceReport(taskData.id, { [name]: processedValue });
  };
  ...
  if (!report) {
    return (
      <View style={styles.container}>
        <Text style={[{ color: theme.colors.danger }, styles.noDataText]}>No Entry Restricted Residence report data available.</Text>
      </View>
    );
  }
  ...
  return (
    <AutoSaveFormWrapper
      ...
      <ScrollView style={styles.container}>
        <Text style={[styles.title, { color: theme.colors.text }]}>Entry Restricted Residence Report</Text>
