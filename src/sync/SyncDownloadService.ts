    ...
    await SyncEngineRepository.execute(
      `INSERT INTO tasks
       ...
       ON CONFLICT(id) DO UPDATE SET
         ...
         completed_at = excluded.completedAt,
         ...
         is_revoked = excluded.isRevoked,
         revoked_at = excluded.revokedAt,
         revoked_by_name = excluded.revokedByName,
         revoke_reason = excluded.revokeReason,
         in_progress_at = excluded.inProgressAt,
         saved_at = excluded.savedAt,
         is_saved = excluded.isSaved,
         attachment_count = excluded.attachmentCount,
         sync_status = 'SYNCED',
