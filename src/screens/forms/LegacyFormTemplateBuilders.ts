...
const legacyShiftedResidenceFields = withLegacyResidenceOrder([
  ...
  { name: 'metPersonName', label: 'Met Person', type: 'text', conditional: legacyCondition('roomStatus', 'equals', 'Open'), requiredWhen: legacyCondition('roomStatus', 'equals', 'Open') },
  { name: 'metPersonStatus', label: 'Met Person Status', type: 'select', conditional: legacyCondition('roomStatus', 'equals', 'Open'), requiredWhen: legacyCondition('roomStatus', 'equals', 'Open') },
...
const legacyPositiveBuilderFields = withLegacyBusinessOrder([
  ...
  { name: 'houseStatus', label: 'House Status', type: 'select', required: true },
  { name: 'metPersonName', label: 'Met Person Name', type: 'text', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
  { name: 'relation', label: 'Relation', type: 'select', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
  { name: 'nameOnBoard', label: 'Name on Board', type: 'text', required: true },
  { name: 'businessType', label: 'Business Type', type: 'select', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
  { name: 'ownershipType', label: 'Ownership Type', type: 'select', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
  { name: 'addressStatus', label: 'Address Status', type: 'select', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
  { name: 'staffStrength', label: 'Staff Strength', type: 'number', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
  { name: 'staffSeen', label: 'Staff Seen', type: 'number', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
  { name: 'approxArea', label: 'Approx Area (Sq. Feet)', type: 'number', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
  { name: 'designation', label: 'Designation', type: 'select', conditional: legacyCondition('houseStatus', 'equals', 'Open'), requiredWhen: legacyCondition('houseStatus', 'equals', 'Open') },
...
const legacyShiftedBuilderFields = withLegacyBusinessOrder([
  ...
  { name: 'metPersonName', label: 'Met Person', type: 'text', conditional: legacyCondition('officeStatus', 'equals', 'Open'), requiredWhen: legacyCondition('officeStatus', 'equals', 'Open') },
...
const legacyNspNocFields = withLegacyNocOrder([
  ...
  },
  {
    ...
    requiredWhen: [
      ...
      legacyCondition('companyNamePlateStatus', 'equals', 'SIGHTED AS'),
    ],
  },
  {
    name: 'tpcMetPerson1',
...
const legacyPositiveDsaFields = withLegacyDsaOrder([
  ...
  { name: 'officeStatus', label: 'Office Status', type: 'select', required: true },
  {
    ...
    label: 'Company Nature of Business',
    type: 'text',
    conditional: legacyCondition('officeStatus', 'in', ['Open', 'Closed']),
    requiredWhen: legacyCondition('officeStatus', 'in', ['Open', 'Closed']),
  },
  {
