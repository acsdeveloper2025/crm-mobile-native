/**
 * Field Executive Acknowledgement — the full 10-section policy text
 * shown both at first-launch consent gate (PrivacyConsentScreen) AND on
 * Profile → Privacy Policy (PrivacyPolicyScreen).
 *
 * SINGLE SOURCE OF TRUTH. Edit here only — both screens pick it up.
 * When changing materially, bump POLICY_VERSION in PrivacyConsentService
